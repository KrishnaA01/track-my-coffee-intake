    ...
    useEffect(()=> {
        if (Object.keys(data).length === 0) {
            localStorage.setItem('data', JSON.stringify(
                [
                   {id:1, name: "Laurenz", cups: 4, isHundred: false, quotation:quote},
                   {id:2, name: "Onia", cups: 8, isHundred: false, quotation:quote},
                   {id:3, name: "Sanjeet", cups: 8, isHundred: false, quotation:quote},
                   {id:4, name: "Joh", cups: 9, isHundred: false, quotation:quote},
                   {id:5, name: "Krishna", cups: 14, isHundred: false, quotation:quote},
                   {id:6, name: "Lukas", cups: 6, isHundred: false, quotation:quote},
                   {id:7, name: "Firas", cups: 15, isHundred: false, quotation:quote}
                ] 
                 ));
        } else
